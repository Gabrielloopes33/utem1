...
- Rode `npm run validate:structure`
- Rode `npm run validate:agents` quando alterar agentes AIOS
- Não há `npm test` configurado neste projeto hoje; não assuma suite de testes inexistente
