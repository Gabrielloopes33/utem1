-- ============================================
-- Criar tabelas de concorrentes no schema PUBLIC
-- (Mais simples, já vem configurado no Supabase)
-- ============================================

-- 1. Tabela de dados dos concorrentes
...
-- 2. Tabela de posts dos concorrentes
...
-- ============================================
-- Pronto! As tabelas estão no schema public
-- ============================================
